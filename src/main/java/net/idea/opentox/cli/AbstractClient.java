...
public abstract class AbstractClient<IDENTIFIER,T extends IIdentifiableResource<IDENTIFIER>> {
	 ...
	 * @throws IOException
	 */
	protected List<T> get(IDENTIFIER url,String mediaType) throws RestException, IOException {
