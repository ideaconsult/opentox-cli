 ...
 * 
 */
public class Compound extends AbstractURLResource {
	/**
	 * 
	 */
	...
	public Compound(IIdentifier id) {
		super(id);
	}
	...
	/*
	 * public Object[] parseURI(String baseReference) { return
	 * OpenTox.URI.conformer.getIds(getResourceURL().toString(),baseReference);
	 * 
	 * }
	 */
	private IIdentifier resourceID;
	...
	public void setResourceIdentifier(IIdentifier resourceID) {
